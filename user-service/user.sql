...
(
    ...
    user_seq_id varchar(30) default '' null comment '用户唯一识别号',
    ...
    user_remark nvarchar(200) default '' null comment '用户备注',
    user_create_time datetime default current_time() null comment '创建时间',
    user_update_time datetime default current_time() null comment '修改时间'
)
comment '用户表';